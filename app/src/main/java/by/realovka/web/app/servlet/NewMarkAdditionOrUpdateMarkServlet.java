...
//            return;
//        }
//        userService.addOrUpdateMark(studentId, themeName, mark);
//        List<Student> students = userService.getTrainerStudents(auth);
//        req.getSession().setAttribute("listStudentsOfTrainer", students);
//        req.getRequestDispatcher("mainTrainer.jsp").forward(req, resp);
//    }
//}
